    ...
    <DashboardLayout role="restaurant">
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage your restaurant information</p>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-start gap-6">
              <div className="relative">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-green-500 to-orange-500 flex items-center justify-center text-white text-4xl">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-green-600">Verified Restaurant</span>
                  </div>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input value={user?.fssaiNumber} disabled={!editing} />
            </div>
            <div>
              <Label>Address</Label>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <p className="text-3xl text-orange-600">1,200</p>
                <p className="text-sm text-slate-600">Meals Served</p>
              </div>
              <div>
                <p className="text-3xl text-blue-600">4.8</p>
