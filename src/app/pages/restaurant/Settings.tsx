      ...
      <div className="space-y-8 max-w-2xl mx-auto">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button className="bg-green-600 hover:bg-green-700 w-full" onClick={handleChangePassword}>
              Update Password
            </Button>
          </CardContent>
        </Card>
            ...
            {!showForgotFlow ? (
              <div className="flex items-center justify-between">
                <p className="text-sm text-slate-600">
                  Forgot your password? We'll send you reset instructions.
                </p>
                <Button variant="outline" onClick={() => setShowForgotFlow(true)}>
                  Reset Password
                </Button>
              </div>
            ) : forgotSent ? (
              <div className="text-center py-4">
                ...
                <Button
                  variant="outline"
                  className="mt-3"
                  onClick={() => { setShowForgotFlow(false); setForgotSent(false); setForgotEmail(''); }}
                >
                  Done
                </Button>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Button className="bg-blue-600 hover:bg-blue-700" onClick={handleForgotPassword}>
                    Send Reset Link
                  </Button>
                  <Button variant="outline" onClick={() => { setShowForgotFlow(false); setForgotEmail(''); }}>
                    Cancel
                  </Button>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {[
              { label: 'Email notifications for donation updates', key: 'email_donations', defaultOn: true },
              { label: 'SMS alerts for new NGO requests', key: 'sms_requests', defaultOn: true },
              { label: 'Push notifications for chat messages', key: 'push_chat', defaultOn: false },
              { label: 'Weekly impact report', key: 'weekly_report', defaultOn: true },
            ].map((pref) => (
              <div key={pref.key} className="flex items-center justify-between py-2 border-b border-slate-100 last:border-0">
                ...
                <button
                  className={`w-12 h-6 rounded-full transition-colors ${pref.defaultOn ? 'bg-green-500' : 'bg-slate-300'}`}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-500 mb-4">
                    This action cannot be undone. All your donation history, chat messages, and profile data will be permanently deleted.
                  </p>
                  <Button
                    variant="outline"
              ...
              <AnimatePresence>
                ...
                >
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    ...
                    <p className="text-red-600 text-sm">Enter your password to confirm account deletion:</p>
                  </div>
